...
- `dist\WindowsLANRemote-1.0.4-portable.zip`：免安装桌面程序（解压后运行其中的 EXE）
- `dist\WindowsLANRemoteSetup-1.0.4.exe`：管理员安装包
- `dist\WindowsLANRemoteService-1.0.4.exe`：构建产生的安全桌面服务组件
